...
/// <summary>
///     Flags any field or auto-property that carries an inline initializer (<c>= value</c>).
///     All initialization — including primitive literals, <c>null</c>, and object creation — must
///     be performed inside the constructor (or static constructor for <c>static</c> members).
///     Exemptions:
///     <list type="bullet">
///         <item><c>const</c> fields — the language mandates inline initialization.</item>
///         <item>
///             Primary-constructor parameter captures — <c>public int X { get; } = x;</c> where
///             <c>x</c> is a primary constructor parameter is already a constructor-based
///             initialization pattern and is allowed.
///         </item>
///     </list>
/// </summary>
...
public sealed class InlineFieldInitializerAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void AnalyzeField(SyntaxNodeAnalysisContext context)
    {
        ...
        foreach (var variable in field.Declaration.Variables)
        {
            ...
            if (IsPrimaryConstructorParameterReference(variable.Initializer.Value, enclosingType))
            {
                continue;
            }
    ...
    private static void AnalyzeProperty(SyntaxNodeAnalysisContext context)
    {
        ...
        if (IsPrimaryConstructorParameterReference(property.Initializer.Value, enclosingType))
        {
            return;
        }
    ...
    private static bool IsConst(FieldDeclarationSyntax field)
    {
    ...
    private static bool IsPrimaryConstructorParameterReference(ExpressionSyntax expression, TypeDeclarationSyntax? enclosingType)
    {
