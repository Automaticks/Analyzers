...
{
    /// <summary>The diagnostic rule reported when a <c>using</c> directive is out of alphabetical order.</summary>
    ...
    private static void AnalyzeCompilationUnit(SyntaxNodeAnalysisContext context)
    {
        ...
        {
            if (!IsRegularUsing(usingDirective))
            {
                continue;
            }
    ...
    private static bool IsRegularUsing(UsingDirectiveSyntax usingDirective)
    {
