...
/// <summary>
///     Flags any top-level <c>using</c> directive that is identical to an earlier directive in the same file.
/// </summary>
[DiagnosticAnalyzer(LanguageNames.CSharp)]
public sealed class DuplicateUsingDirectiveAnalyzer : DiagnosticAnalyzer
{
    /// <summary>
    ///     The diagnostic rule reported when a duplicate <c>using</c> directive is detected.
    /// </summary>
    public static readonly DiagnosticDescriptor Rule;

    static DuplicateUsingDirectiveAnalyzer()
    {
    ...
    private string BuildKey(UsingDirectiveSyntax usingDirective)
    {
