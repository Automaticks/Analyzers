...
/// <summary>
///     Converts the expression body reported by ATXCS079 into a block body.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExpressionBodiedOperatorCodeFixProvider))]
[Shared]
public sealed class ExpressionBodiedOperatorCodeFixProvider : CodeFixProvider
{
    ...
    public override ImmutableArray<string> FixableDiagnosticIds
    {
        get
        {
            return [DiagnosticIds.CSharp.ExpressionBodiedOperator];
        }
    }
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            ...
            var declaration = node.FirstAncestorOrSelf<OperatorDeclarationSyntax>()!;
