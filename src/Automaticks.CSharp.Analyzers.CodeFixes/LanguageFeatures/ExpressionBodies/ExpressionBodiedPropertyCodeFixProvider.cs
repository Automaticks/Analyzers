...
/// <summary>
///     Converts the expression body reported by ATXCS077 into a block body.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExpressionBodiedPropertyCodeFixProvider))]
[Shared]
public sealed class ExpressionBodiedPropertyCodeFixProvider : CodeFixProvider
{
    ...
    public override ImmutableArray<string> FixableDiagnosticIds
    {
        get
        {
            return [DiagnosticIds.CSharp.ExpressionBodiedProperty];
        }
    }
