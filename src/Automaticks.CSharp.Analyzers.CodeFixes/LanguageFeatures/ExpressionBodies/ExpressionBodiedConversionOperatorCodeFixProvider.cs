...
/// <summary>
///     Converts the expression body reported by ATXCS080 into a block body.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExpressionBodiedConversionOperatorCodeFixProvider))]
[Shared]
public sealed class ExpressionBodiedConversionOperatorCodeFixProvider : CodeFixProvider
{
    ...
    public override ImmutableArray<string> FixableDiagnosticIds
    {
        get
        {
            return [DiagnosticIds.CSharp.ExpressionBodiedConversionOperator];
        }
    }
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            ...
            var declaration = node.FirstAncestorOrSelf<ConversionOperatorDeclarationSyntax>()!;
        ...
        CancellationToken cancellationToken)
    {
        ...
        var replacement = ExpressionBodyBlockBuilder.BuildReturnBlock(expressionBody, baseIndent, lineBreak);
