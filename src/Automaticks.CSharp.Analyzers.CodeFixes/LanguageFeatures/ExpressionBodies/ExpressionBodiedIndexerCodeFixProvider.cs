...
/// <summary>
///     Converts the expression body reported by ATXCS078 into a block body.
/// </summary>
[ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(ExpressionBodiedIndexerCodeFixProvider))]
[Shared]
public sealed class ExpressionBodiedIndexerCodeFixProvider : CodeFixProvider
{
    ...
    public override ImmutableArray<string> FixableDiagnosticIds
    {
        get
        {
            return [DiagnosticIds.CSharp.ExpressionBodiedIndexer];
        }
    }
    ...
    public override async Task RegisterCodeFixesAsync(CodeFixContext context)
    {
        ...
        foreach (var diagnostic in context.Diagnostics)
        {
            ...
            var declaration = node.FirstAncestorOrSelf<IndexerDeclarationSyntax>()!;
        ...
        CancellationToken cancellationToken)
    {
        ...
        var replacement = ExpressionBodyBlockBuilder.BuildGetAccessorBlock(expressionBody, baseIndent, lineBreak);
