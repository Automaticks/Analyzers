...
public sealed class SuppressionCommentAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor PragmaRule;
    private static readonly DiagnosticDescriptor ReSharperRule;

    static SuppressionCommentAnalyzer()
    {
        ...
        PragmaRule = pragmaRule;
        ReSharperRule = reSharperRule;
    }
